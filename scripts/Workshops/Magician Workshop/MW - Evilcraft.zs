...
RecipeBuilder.get("mage")
  .setShaped([
	...
	[<bloodmagic:slate:1>, <evilcraft:promise_acceptor>, <evilcraft:bowl_of_promises:3>, <evilcraft:promise_acceptor>, <bloodmagic:slate:1>], 
...
RecipeBuilder.get("mage")
  .setShaped([
	...
	[<bloodmagic:slate:2>, <evilcraft:promise_acceptor:1>, <evilcraft:bowl_of_promises:4>, <evilcraft:promise_acceptor:1>, <bloodmagic:slate:2>], 
...
RecipeBuilder.get("mage")
  .setShaped([
	...
	[<bloodmagic:slate>, <evilcraft:promise_acceptor:1>, <evilcraft:bowl_of_promises:3>, <evilcraft:promise_acceptor:1>, <bloodmagic:slate>], 
	[null, <ore:gemDark>, <ore:blockRedstone>, <ore:gemDark>, null], 
	[null, null, <ore:gemDark>, null, null]])
  .setFluid(<liquid:darkessence> * 2000)
