...
recipes.addShaped(<minecraft:fireworks>.withTag({Fireworks: {Flight: 3 as byte}}) * 16, [[<ore:paper>, <ore:dustSaltpeter>, <ore:paper>],[<overloaded:compressed_sand>, <ore:paper>, <overloaded:compressed_sand>], [<ore:paper>, <immersiveengineering:wooden_device0:4>, <ore:paper>]]);
