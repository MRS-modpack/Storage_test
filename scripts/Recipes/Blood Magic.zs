...
recipes.addShaped(<bloodmagic:blood_rune:1> * 2, [[<bloodmagic:slate>, <quark:sugar_block>, <bloodmagic:slate>],[<taiga:basalt_block>, <bloodmagic:blood_rune>, <taiga:basalt_block>], [<bloodmagic:slate>, <quark:sugar_block>, <bloodmagic:slate>]]);
