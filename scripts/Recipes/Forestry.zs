...
mods.extendedcrafting.TableCrafting.addShaped(0, <forestry:carpenter>, [
	[<ore:plateSteel>, <moreplates:empowered_enori_plate>, <ore:plateSteel>, <moreplates:empowered_enori_plate>, <ore:plateSteel>], 
	[<moreplates:empowered_enori_plate>, <nuclearcraft:part:7>, <ore:gearRestoniaEmpowered>, <ore:circuitStorage>, <moreplates:empowered_enori_plate>], 
	[<ore:plateSteel>, <ore:oc:circuitChip2>, <ore:circuitAdvanced>, <fluidtank:blocktank2:1>, <ore:plateSteel>], 
	[<moreplates:empowered_enori_plate>, <techreborn:part:37>, <projectred-core:resource_item:410>, <techreborn:part:37>, <moreplates:empowered_enori_plate>], 
	[<ore:plateSteel>, <moreplates:empowered_enori_plate>, <ore:plateSteel>, <moreplates:empowered_enori_plate>, <ore:plateSteel>]
]);
