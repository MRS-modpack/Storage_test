...
mods.extendedcrafting.TableCrafting.addShaped(0, <mekanism:machineblock:7>.withTag({recipeType: 6}), [
	...
	[<ore:plateOsgloglas>, <stevescarts:modulecomponents:65>, <ore:alloyUltimate>, <tconstruct:edible:33>, <ore:ingotAstralStarmetal>, <tconstruct:edible:33>, <ore:alloyUltimate>, <stevescarts:modulecomponents:65>, <ore:plateOsgloglas>], 
